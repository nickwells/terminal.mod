...
Note that when it comes to using the available attributes restraint is
advised. While the package makes it possible to display the text in bold,
fast-blinking italic with the text crossed out and doubly underlined, the
foreground colour set to barbie pink and the background set to lime green,
